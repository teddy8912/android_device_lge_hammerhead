...
$(call inherit-product, vendor/twinkle/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/twinkle/config/nfc_enhanced.mk)
...
PRODUCT_NAME := twinkle_hammerhead
